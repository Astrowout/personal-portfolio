...
>
	{#if title}
		<span
			class="text-3xl sm:text-4xl text-slate-900 u-anim-start font-bold font-display"
	...
	{#if subtitle}
		<span
			class="order-first text-3xl sm:text-4xl text-slate-400 u-anim-start font-display"
			class:u-anim-end={isInView}
		>
			{subtitle}
		</span>
