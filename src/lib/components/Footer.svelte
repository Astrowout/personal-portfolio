...
<svelte:element
	...
	class="u-space-x flex flex-col z-10 flex-grow overflow-hidden pb-36 {asPage
		? 'pt-8'
	...
	<div class="u-container-sm w-full flex flex-col flex-grow justify-between">
		...
		<div>
			<div id="wcb" class="carbonbadge">
				...
				<div id="wcb_p">
					<span id="wcb_g">0.13g of CO<sub>2</sub>/view</span><a
						id="wcb_a"
						target="_blank"
						rel="noopener"
				...
				<span id="wcb_2">&nbsp;Cleaner than 87% of pages tested</span>
			</div>
