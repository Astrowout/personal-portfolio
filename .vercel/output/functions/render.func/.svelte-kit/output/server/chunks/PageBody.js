import { c as create_ssr_component, f as add_attribute, e as escape, v as validate_component, k as compute_slots, d as each, l as assign, o as now, p as loop, q as identity, b as subscribe, m as missing_component } from "./index.js";
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"u-space-x py-8 w-full"}"><div class="${"u-container-sm grid md:grid-cols-2 items-center gap-y-6"}"><div class="${[
...
const Section = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="${[
    "w-full u-space-x " + escape(compact ? "u-space-y-sm" : "u-space-y", true),
    noSpacing ? "u-space-y-none" : ""
...
const Tag = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"flex items-center font-medium lg:text-lg text-slate-900 bg-stone-100 rounded-xl border-2 border-slate-200 px-4 py-1 " + escape(className, true)}">${slots.default ? slots.default({}) : ``}</div>`;
});
...
const css = {
  code: ".progress.svelte-1heh3sp{@apply appearance-none w-full h-2 rounded-full overflow-hidden outline outline-1 outline-offset-1 outline-slate-300;}.progress.svelte-1heh3sp::-webkit-progress-bar{@apply bg-slate-50 shadow-inner;}.progress.svelte-1heh3sp::-webkit-progress-value{@apply bg-slate-600 rounded-full;}",
  map: null
};
...
const Progress = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="${"flex flex-grow flex-col items-center gap-y-2 " + escape(className, true) + " svelte-1heh3sp"}"><progress${add_attribute("value", $progress, 0)} max="${"100"}" class="${"progress svelte-1heh3sp"}"><span style="${"width: " + escape(value, true) + "%;"}">${escape(value)}%
        </span></progress>
...
const WorkPreview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.__typename === void 0 && $$bindings.__typename && __typename !== void 0)
    $$bindings.__typename(__typename);
  return `<a href="${"/work/" + escape(slug, true)}" class="${"group flex flex-col items-center"}">${title ? `<h4 class="${"inline-block relative -z-10 text-center sm:text-lg lg:text-xl text-white rounded-xl u-font-display uppercase px-4 pt-2 pb-4 bg-slate-900 translate-y-4 xl:translate-y-16 transition-transform duration-500 ease-in-out group-hover:translate-y-2"}">${escape(title)}</h4>` : ``}

	${image ? `<img${add_attribute("alt", image.alt, 0)}${add_attribute("src", image.url, 0)}${add_attribute("width", image.width, 0)}${add_attribute("height", image.height, 0)} class="${"object-contain transition duration-500 ease-in-out w-full relative z-10 drop-shadow group-hover:scale-105 group-hover:drop-shadow-xl"}">` : ``}</a>`;
});
const WorkGroup = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.__typename === void 0 && $$bindings.__typename && __typename !== void 0)
    $$bindings.__typename(__typename);
  $$unsubscribe_page();
  return `<div class="${"flex flex-col items-center"}"><div class="${"w-full grid lg:grid-cols-2 gap-x-6 gap-y-10 items-start"}">${each(works, (item, index) => {
